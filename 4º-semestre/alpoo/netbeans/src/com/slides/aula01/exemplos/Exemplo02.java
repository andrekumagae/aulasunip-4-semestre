package com.slides.aula01.exemplos;// Classe: com.slides.aula01.exemplos.Exemplo02.java
/* Exemplo de cria��o de frame com Labels, Textos e bot�es */
...
public class Exemplo02 extends Frame {
    ...
    public Exemplo02() {
		...
		/* Este pr�ximo comando vai obrigar a definir 
		   o tamanho e a posi��o de cada objeto dentro do frame */
        setLayout(null);

        L1 = new Label("ESTA � UMA CLASSE PARA SOMA DE VALORES");
        ...
        add(L1);  // Os objetos t�m que ser adicionados ao Frame
        add(L2);
        add(L3);
        add(B1);
        add(B2);
    ...
    // Classe interna para ouvir e tratar o evento (bot�es)
